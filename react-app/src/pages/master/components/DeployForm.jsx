      ...
      <form method="POST" action="master.php" onSubmit={() => setIsSubmitting(true)} className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="relative group">
            ...
            <input type="text" name="storeName" required placeholder="Business Name" className="w-full bg-white/[0.03] border border-white/5 rounded-xl py-3 pl-10 pr-3.5 text-sm text-white placeholder-neutral-600 focus:border-indigo-500/50 outline-none transition-all" />
          </div>
        ...
        <div className="space-y-4">
          <div className="relative group">
            ...
            <input type="password" name="storePassword" required placeholder="Admin Keyphrase" className="w-full bg-white/[0.03] border border-white/5 rounded-xl py-3 pl-10 pr-3.5 text-sm text-white placeholder-neutral-600 focus:border-indigo-500/50 outline-none transition-all" />
          </div>
          <div className="relative group">
            ...
            <input type="text" name="whatsappNumber" required placeholder="WhatsApp (62...)" className="w-full bg-white/[0.03] border border-white/5 rounded-xl py-3 pl-10 pr-3.5 text-sm text-white placeholder-neutral-600 focus:border-indigo-500/50 outline-none transition-all" />
          </div>
        </div>

        <div className="space-y-2">
          <label className="text-[10px] font-bold uppercase tracking-widest text-neutral-600 ml-1">AI Context & Persona</label>
          <textarea name="aiContext" required rows="3" placeholder="Provide background info for the AI Assistant..." className="w-full bg-white/[0.03] border border-white/5 rounded-xl p-3.5 text-sm text-white placeholder-neutral-600 focus:border-indigo-500/50 outline-none transition-all resize-none leading-relaxed" />
        </div>
